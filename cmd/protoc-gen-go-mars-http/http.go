...
// generateFile generates a _http.pb.go file containing mars errors definitions.
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool) *protogen.GeneratedFile {
	...
	g.P("// Code generated by protoc-gen-go-mars-http. DO NOT EDIT.")
	g.P("// versions:")
	g.P(fmt.Sprintf("// - protoc-gen-go-mars-http %s", release))

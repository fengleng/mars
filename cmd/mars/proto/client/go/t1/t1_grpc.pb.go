...
type T1Client interface {
	...
	ListT1(ctx context.Context, in *ListT1Req, opts ...grpc.CallOption) (*ListT1Rsp, error)
}
...
func (c *t1Client) ListT1(ctx context.Context, in *ListT1Req, opts ...grpc.CallOption) (*ListT1Rsp, error) {
	out := new(ListT1Rsp)
	err := c.cc.Invoke(ctx, "/t1.T1/ListT1", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedT1Server) ListT1(context.Context, *ListT1Req) (*ListT1Rsp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListT1 not implemented")
}
...
func _T1_ListT1_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListT1Req)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(T1Server).ListT1(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/t1.T1/ListT1",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(T1Server).ListT1(ctx, req.(*ListT1Req))
	}
	return interceptor(ctx, in, info, handler)
}

...
func BadRequest(reason, message string) *Error {
	return New(400, reason).WithMessage(message)
}
...
func Unauthorized(reason, message string) *Error {
	return New(401, reason).WithMessage(message)
}
...
func Forbidden(reason, message string) *Error {
	return New(403, reason).WithMessage(message)
}
...
func NotFound(reason, message string) *Error {
	return New(404, reason).WithMessage(message)
}
...
func Conflict(reason, message string) *Error {
	return New(409, reason).WithMessage(message)
}
...
func InternalServer(reason, message string) *Error {
	return New(500, reason).WithMessage(message)
}
...
func ServiceUnavailable(reason, message string) *Error {
	return New(503, reason).WithMessage(message)
}
...
func GatewayTimeout(reason, message string) *Error {
	return New(504, reason).WithMessage(message)
}
...
func ClientClosed(reason, message string) *Error {
	return New(499, reason).WithMessage(message)
}
